      ...
      <CardHeader>
        <div className="flex items-center justify-between w-full">
          ...
          <button
            ...
            aria-label={analysis ? 'Re-analyze session' : 'Analyze session with AI'}
      ...
      {!isLoading && !analysis && !isAnalyzing && !mutation.isError && (
        <div className="text-center py-6">
          ...
          <p className="text-muted text-xs mt-1">
            Click "Analyze with AI" to get AI-powered insights on this lifting session
          </p>
        </div>
      )}
      ...
      {isAnalyzing && (
        <div className="flex items-center gap-3 py-4">
          ...
          <p className="text-sm text-muted">
            Analyzing session data with Gemini... This may take 10-20 seconds.
          </p>
        </div>
      )}
