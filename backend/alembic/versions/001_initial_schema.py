...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("connection_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("oauth_connections.id", ondelete="SET NULL"), nullable=True),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.UniqueConstraint("source", "provider_activity_id", name="uq_activity_source_provider_id"),
    )
    ...
    op.create_table(
        "activity_streams",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("activity_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("activities.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    op.create_table(
        "lifting_sets",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("session_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("lifting_sessions.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column("activity_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("activities.id", ondelete="SET NULL"), nullable=True),
        sa.Column("session_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("lifting_sessions.id", ondelete="SET NULL"), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
    )
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.UniqueConstraint("user_id", "metric_date", "source", name="uq_daily_metric_user_date_source"),
    )
