"""
Test render: verify textures are visible with high sample count and good lighting.
"""
import bpy, os, sys
...
# Build full PBR material with proper normal map strength
